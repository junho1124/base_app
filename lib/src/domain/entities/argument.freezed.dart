...
mixin _$Argument<T> {
  ...
  @JsonKey(ignore: true)
  $ArgumentCopyWith<T, Argument<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ArgumentCopyWith<T, $Res> {
  factory $ArgumentCopyWith(
          Argument<T> value, $Res Function(Argument<T>) then) =
      _$ArgumentCopyWithImpl<T, $Res, Argument<T>>;
  @useResult
  $Res call({T data});
}

/// @nodoc
class _$ArgumentCopyWithImpl<T, $Res, $Val extends Argument<T>>
    implements $ArgumentCopyWith<T, $Res> {
...
/// @nodoc
abstract class _$$DataCopyWith<T, $Res> implements $ArgumentCopyWith<T, $Res> {
...
class __$$DataCopyWithImpl<T, $Res>
    extends _$ArgumentCopyWithImpl<T, $Res, _$Data<T>>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  String toString() {
    return 'Argument<$T>.data(data: $data)';
  }
...
abstract class Data<T> implements Argument<T> {
